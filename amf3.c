...
static PHP_MINIT_FUNCTION(amf3) {
	...
	REGISTER_LONG_CONSTANT("AMF3_AUTOLOAD", AMF3_AUTOLOAD, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("AMF3_CONSTRUCT", AMF3_CONSTRUCT, CONST_CS | CONST_PERSISTENT);
	return SUCCESS;
}
